...
/* global CodeMirror, Cookies, moment, serverurl,
   key, Dropbox, ot, hex2rgb, Visibility, inlineAttachment, initImagePicker */
...
var noteAlias = decodeURIComponent(window.location.pathname.replace(new RegExp('^/' + (window.urlpath || '') + '/'), ''))
var inlineAttach = inlineAttachment.editors.codemirror4.attach(editor, {
  uploadUrl: '/' + (window.urlpath ? window.urlpath + '/' : '') + 'uploadimage',
  extraParams: { noteAlias: noteAlias }
})

// Initialize image picker
var imagePicker = initImagePicker()
