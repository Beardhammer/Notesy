...
func addConfigFlags(flags *pflag.FlagSet) {
	...
	flags.String("branding.name", "Red Team CISA", "Brand title name")
	flags.String("branding.color", "", "set the theme color")
	flags.String("branding.theme", "dark", "Set the theme light/dark")
	flags.String("branding.files", "", "path to directory with images and custom styles")
	flags.Bool("branding.disableExternal", false, "disable external links such as GitHub links")
	flags.Bool("branding.disableUsedPercentage", false, "disable used disk percentage graph")

	flags.String("onlyoffice.url", "", "OnlyOffice Document Server URL")
	flags.String("onlyoffice.jwtSecret", "", "OnlyOffice Document Server JWT Secret")
	flags.String("codimd.url", "", "CodiMD URL")
	flags.String("drawio.url", "", "DrawIO URL")
}
...
func printSettings(ser *settings.Server, set *settings.Settings, auther auth.Auther) {
	...
	fmt.Fprintln(w, "\nRTA Settings:")
	fmt.Fprintf(w, "\t\tOnly Office URL:\t%s\n", set.OnlyOffice.URL)
	fmt.Fprintf(w, "\t\tOnly Office JWT:\t%s\n", set.OnlyOffice.JWTSecret)
	fmt.Fprintf(w, "\t\tCodiMD URL:\t%s\n", set.CodiMd.URL)
	fmt.Fprintf(w, "\t\tDrawIO URL:\t%s\n", set.DrawIO.URL)
	fmt.Fprintln(w, "\nDefaults:")
