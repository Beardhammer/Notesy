    ...
    <div class="column">
      <form class="card" @submit.prevent="save">
        ...
        <div class="card-content">
          ...
          <h3>{{ $t("settings.codiMd") }}</h3>
          <div class="codiMdSettings">
            <p>
              <label for="codimd-url">{{
                $t("settings.codiMdUrl")
              }}</label>
              <input
                class="input input--block"
                type="text"
                v-model="settings.codimd.url"
                id="codimd-url"
              />
            </p>
          </div>

          <h3>{{ $t("settings.drawIO") }}</h3>
          <div class="drawIOSettings">
            <p>
              <label for="drawio-url">{{
                $t("settings.drawIOUrl")
              }}</label>
              <input
                class="input input--block"
                type="text"
                v-model="settings.drawio.url"
                id="drawio-url"
              />
            </p>
          </div>
