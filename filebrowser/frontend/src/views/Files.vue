...
import { drawIO } from "@/utils/constants";
...
export default {
  ...
  components: {
    ...
    CodiMdEditor: () => import("@/views/files/CodiMdEditor.vue"),
    DrawIOEditor: () => import("@/views/files/DrawIOEditor.vue"),
  },
  data: function () {
    return {
      error: null,
  ...
  computed: {
    ...
    currentView() {
      ...
      if (this.req.isDir) {
        return "listing";
      } else if (this.req.type === "codimd" && codiMd.url !== "") {
        return "CodiMdEditor";
      } else if (this.req.type === "onlyoffice" && onlyOffice.url !== "") {
        return "OnlyOfficeEditor";
      } else if (this.req.type === "drawio" && drawIO.url !== "") {
        return "DrawIOEditor";
