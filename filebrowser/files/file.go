...
func (i *FileInfo) detectType(modify, saveContent, readHeader bool) error {
	...
	switch {
	case slices.Contains(codiMdExtensions, i.Extension):
		i.Type = "codimd"
		return nil
	case slices.Contains(onlyOfficeExtensions, i.Extension):
		i.Type = "onlyoffice"
		return nil
	case slices.Contains(drawIOExtensions, i.Extension):
		i.Type = "drawio"
		return nil
