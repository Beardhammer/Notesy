...
type settingsData struct {
	...
	CodiMd		       settings.CodiMd       `json:"codimd"`
	DrawIO		       settings.DrawIO       `json:"drawio"`
}
...
var settingsGetHandler = withAdmin(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
	data := &settingsData{
		...
		CodiMd:           d.settings.CodiMd,
		DrawIO:						d.settings.DrawIO,
	}
...
var settingsPutHandler = withAdmin(func(w http.ResponseWriter, r *http.Request, d *data) (int, error) {
	...
	d.settings.CodiMd = req.CodiMd
	d.settings.DrawIO = req.DrawIO
